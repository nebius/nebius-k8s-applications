...
**To install the product:**
   ...
   1. Configure the application:
      ...
      {% note info %}
         ...
         It is stronly recommended to keep the default values for the [head pod](https://docs.ray.io/en/latest/cluster/kubernetes/user-guides/config.html#pod-configuration-headgroupspec-and-workergroupspecs) and non-GPU worker pods so that each pod takes up an entire node.
...
**To check that Ray is working:**
   ...
   2. Go to [http://localhost:8000/](http://localhost:8000/imagine?prompt=a%20cute%20cat) to access a Ray Serve application.
