...
*/}}
{{- define "redis.image" -}}
{{ include "redis.common.images.image" (dict "imageRoot" .Values.image "global" .Values.global) }}
{{- end -}}
...
{{ include "redis.common.images.image" (dict "imageRoot" .Values.sentinel.image "global" .Values.global) }}
{{- end -}}
...
{{ include "redis.common.images.image" (dict "imageRoot" .Values.metrics.image "global" .Values.global) }}
{{- end -}}
...
{{ include "redis.common.images.image" (dict "imageRoot" .Values.volumePermissions.image "global" .Values.global) }}
{{- end -}}
...
{{ include "redis.common.images.image" (dict "imageRoot" .Values.sysctl.image "global" .Values.global) }}
{{- end -}}
...
{{- include "redis.common.images.renderPullSecrets" (dict "images" (list .Values.image .Values.sentinel.image .Values.metrics.image .Values.volumePermissions.image .Values.sysctl.image) "context" $) -}}
{{- end -}}
...
{{- if .Values.serviceAccount.create -}}
    {{ default (include "redis.common.names.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
...
{{- if .Values.master.serviceAccount.create -}}
    {{ default (printf "%s-master" (include "redis.common.names.fullname" .)) .Values.master.serviceAccount.name }}
{{- else -}}
    {{- if .Values.serviceAccount.create -}}
...
{{- if .Values.replica.serviceAccount.create -}}
    {{ default (printf "%s-replica" (include "redis.common.names.fullname" .)) .Values.replica.serviceAccount.name }}
{{- else -}}
    {{- if .Values.serviceAccount.create -}}
        {{ template "redis.serviceAccountName" . }}
    {{- else -}}
...
{{- else -}}
    {{- printf "%s-configuration" (include "redis.common.names.fullname" .) -}}
{{- end -}}
{{- end -}}
...
{{- if or .Values.auth.enabled .Values.global.redis.password }}
    ...
    {{- else -}}
        {{- include "getValueFromSecret" (dict "Namespace" (include "redis.common.names.namespace" .) "Name" (include "redis.secretName" .) "Length" 10 "Key" (include "redis.secretPasswordKey" .))  -}}
    {{- end -}}
{{- end -}}
{{- end }}
...
{{- include "redis.common.warnings.rollingTag" .Values.image }}
{{- include "redis.common.warnings.rollingTag" .Values.sentinel.image }}
{{- include "redis.common.warnings.rollingTag" .Values.metrics.image }}
{{- end -}}
...
{{ printf "%s.%s" (include "redis.common.names.fullname" .) .Values.useExternalDNS.suffix }}
{{- end -}}
